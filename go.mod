module github.com/cellargalaxy/jotcash

go 1.27.0

require (
	github.com/bojanz/currency v1.5.0
	github.com/cellargalaxy/go_common v0.0.0-20260914163401-f645af786eea
...
require (
	...
	github.com/gocarina/gocsv v0.0.0-20260824135904-1713ebc4797a // indirect
